...
import com.artemkaxboy.redmineexporter.schedule.ActivityWithHours
import org.springframework.data.jpa.repository.JpaRepository
import org.springframework.data.jpa.repository.Query

interface TimeEntryRepository : JpaRepository<TimeEntry, Long> {

    @Query("SELECT new com.artemkaxboy.redmineexporter.schedule.ActivityWithHours(t.activityId, SUM(t.hours)) FROM TimeEntry t WHERE t.userId = :userId AND t.year = :year AND t.month = :month GROUP BY t.activityId")
